...
public class WelcomeScreen extends AppCompatActivity implements BGABanner.Adapter<ImageView, LoginBannerPic.ImageAdModel>,BGABanner.Delegate<ImageView,LoginBannerPic.ImageAdModel> {
    ...
    private void initWelcome() {
        switch (WelcomeScreen.SELECT_MODE) {
            case 1:
                fastWelcome();
                break;
            case 2:
    ...
    private void skipToTestActivity() {
        // token未过期，跳转到主界面
        Intent intent = new Intent(WelcomeScreen.this, TestActivity.class);
