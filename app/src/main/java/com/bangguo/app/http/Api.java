...
import com.bangguo.common.utils.NetWorkUtils;
...
public class Api {
    ...
    private static HttpCommonParamInterceptor.Builder builder = new HttpCommonParamInterceptor.Builder();;
   ...
   1. noCache 不使用缓存，全部走网络
    ...
    private Api(int hostType) {
        ...
        okHttpClient = new OkHttpClient.Builder()
                ...
                .addInterceptor(httpCommonParamInterceptor)
    ...
    private final HttpCommonParamInterceptor httpCommonParamInterceptor = builder.build();

    public void setCommonParams(Map<String,String> params, ParamsType type){
        switch (type){
            case PARAM_MAP:
                builder.addParamsMap(params);
                break;
            case QUERY_PARAM_MAP:
                builder.addQueryParamsMap(params);
                break;
            case HEADER_PARAM_MAP:
                builder.addHeaderParamsMap(params);
                break;
        }
    }
}