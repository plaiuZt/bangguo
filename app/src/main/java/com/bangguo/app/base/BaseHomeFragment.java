...
import com.bangguo.app.activity.MainActivity;
import com.bangguo.app.adapter.WidgetItemAdapter;
...
public abstract class BaseHomeFragment extends BaseFragment implements RecyclerViewHolder.OnItemClickListener<PageInfo> {
    ...
    protected TitleBar initTitle() {
        ...
        titleBar.addAction(new TitleBar.ImageAction(R.drawable.ic_action_about) {
            @Override
            @SingleClick
